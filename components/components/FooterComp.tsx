...
//               src={"/logo/vemre1.png"}
//               alt="Vemre Logo"
//               className="w-36 h-32 md:w-36 md:h-[140px] lg:ml-10 lg:mx-32 md:mx-8"
//             />
//           </div>
...
//                   <h1 className="text-sm font-semibold border py-2 px-2 flex gap-3 items-center bg-black hover:bg-[#123b49]">
//                     {" "}
//                     <FaGooglePlay /> Google{" "}
//                   </h1>
//                 </div>
...
//                   <h1 className="text-[14px] font-semibold border py-2 px-2 flex gap-2 items-center bg-black hover:bg-[#123b49]">
//                     {" "}
//                     <FaApple /> Apple{" "}
//                   </h1>
//                 </div>
...
//           <a
//             href="https://www.vemre.com/terms"
//             className="text-white underline"
//           >
//             Terms & Conditions
//           </a>
//           <a
//             href="https://www.vemre.com/privacy"
//             className="text-white underline"
//           >
//             Privacy Policy
//           </a>
...
//         <div>
//           <p className="text-[12px] md:text-[16px] py-4">
//             &copy; {new Date().getFullYear()} Vemre. All rights reserved.
//           </p>
//         </div>
//         <div>
//           <p className="text-[10px] md:text-sm pb-4 border-t py-2">
//             Designed & Developed by{" "}
//             <a
//               className="text-teal-300 underline font-bold font-font2 text-xs md:text-sm hover:text-teal-400"
//               target="blank"
//               href="https://wa.me/message/4HWTHZBEQK2EA1"
//             >
//               Netly Tech Solutions
//             </a>
//           </p>
//         </div>
//       </div>
  ...
  return (
    <footer className="bg-[#0b573d] text-white">
      ...
      <div className="container flex flex-col items-center">
        <div className="flex flex-col md:flex-row justify-between items-center w-full mb-4">
          <div className="mb-4 md:mb-0 flex justify-center">
            <img src={"/logo/vemre1.png"} alt="Vemre Logo" className='w-36 h-32 md:w-36 md:h-[140px] lg:ml-10 lg:mx-32 md:mx-8' />
          </div>
