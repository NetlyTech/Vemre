  ...
  const ContactHeader: React.FC = () => {
    return (
      <div className="flex items-center rounded-b-sm shadow-lg justify-center mb-8 w-full">
       ...
       <div>
         <h4 className="text-green-800 text-center text-xl md:text-4xl font-extrabold mb-2">Get In Touch</h4>
        <h1 className="text-center text-[14px] md:text-[16px] lg:text-[20px] font-bold mb-4">
